...
const DropdownTitle = styled.h3`
    ...
    ${(props) => !props.$isUnderlineTitle && css`
        &::before {
            content: ''; 
...
const AllbirdsSection = ({ delay }) => (
    <DropdownSection $delay={delay}>
        <DropdownTitle>올버즈</DropdownTitle>
        <SubMenuList>
            <SubMenuItem><SubMenuLink to="/about/story">브랜드 스토리</SubMenuLink></SubMenuItem>
            <SubMenuItem><SubMenuLink to="/about/sustainability">지속 가능성</SubMenuLink></SubMenuItem>
            <SubMenuItem><SubMenuLink to="/about/materials">소재</SubMenuLink></SubMenuItem>
            <SubMenuItem><SubMenuLink to="/about/repair">수선</SubMenuLink></SubMenuItem>
        </SubMenuList>
    </DropdownSection>
);
...
const MenuGroup = ({ title, links, delay }) => (
    <DropdownSection $delay={delay}>
        <DropdownTitle $isUnderlineTitle={title === '유아/어린이'}>{title}</DropdownTitle>
        <SubMenuList>
            {links.map((link, index) => (
                <SubMenuItem key={index}><SubMenuLink to={link.to}>{link.label}</SubMenuLink></SubMenuItem>
            ))}
        </SubMenuList>
    </DropdownSection>
);
...
const SustainabilityDropdown = () => (
    <DropdownContentWrapper>
        ...
        <MenuGroup 
            title="소식" 
            links={[
                { label: "캠페인", to: "/sustainability/news/campaign" },
