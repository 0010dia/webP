...
const sectionSlideIn = keyframes`
    from {
        opacity: 0;
    ...
    css`
      ...
      &:hover {
        &::before {
          ...
          opacity: 1;
          margin-right: 12px;
          animation: ${lineSlide} 0.3s ease-out forwards;
        }
      }
    `}
...
const SearchIcon = () => (
  ...
  >
    <path
      d="M11.2276 3.24948C10.1722 3.23718 9.12482 3.43443 8.1462 3.8298C7.16758 4.22518 6.27715 4.81081 5.52649 5.55277C4.77583 6.29474 4.17986 7.17829 3.77311 8.15223C3.36636 9.12617 3.15692 10.1711 3.15692 11.2266C3.15692 12.2821 3.36636 13.327 3.77311 14.301C4.17986 15.2749 4.77583 16.1585 5.52649 16.9004C6.27715 17.6424 7.16758 18.228 8.1462 18.6234C9.12482 19.0188 10.1722 19.216 11.2276 19.2037C13.3271 19.1793 15.3324 18.328 16.8084 16.8347C18.2845 15.3414 19.1123 13.3263 19.1123 11.2266C19.1123 9.1269 18.2845 7.11185 16.8084 5.61851C15.3324 4.12517 13.3271 3.27395 11.2276 3.24948Z"
      strokeMiterlimit="10"
    />
    <path
      d="M17.1783 17.1799L22.7499 22.7515"
      strokeMiterlimit="10"
      strokeLinecap="round"
    />
  </svg>
...
const CartIcon = () => (
  ...
  >
    <path
      d="M7.02456 5.9695V4.9756C7.02456 3.92121 7.44341 2.91 8.18898 2.16443C8.93455 1.41886 9.94576 1 11.0002 1C12.0546 1 13.0658 1.41886 13.8113 2.16443C14.5569 2.91 14.9758 3.92121 14.9758 4.9756V5.9695M20.4422 21.375V6.46645H1.55811V21.375H20.4422Z"
      strokeMiterlimit="10"
      strokeLinecap="round"
      strokeLinejoin="round"
    />
...
const NewProducts = ({ prefix, delay }) => (
  <DropdownSection $delay={delay}>
    <DropdownTitle>신제품</DropdownTitle>
    <SubMenuList>
      <SubMenuItem>
        <SubMenuLink to={`/new/${prefix}/nz`}>울러너 NZ</SubMenuLink>
      </SubMenuItem>
      <SubMenuItem>
        <SubMenuLink to={`/new/${prefix}/slipers`}>코두로이 슬립온</SubMenuLink>
      </SubMenuItem>
      <SubMenuItem>
        <SubMenuLink to={`/new/${prefix}/cruiser`}>울 크루져</SubMenuLink>
      </SubMenuItem>
      <SubMenuItem>
        <SubMenuLink to={`/new/${prefix}/cruiser-slipers`}>
          울 크루져 슬립온
        </SubMenuLink>
      </SubMenuItem>
      {prefix === "m" ? (
        <SubMenuItem>
          <SubMenuLink to="/new/m/mix-exp">크루져 미드 믹스플로어</SubMenuLink>
        </SubMenuItem>
      ) : (
        <SubMenuItem>
          <SubMenuLink to="/new/w/mix-exp">스트라이더 믹스플로어</SubMenuLink>
        </SubMenuItem>
      )}
      {prefix === "m" && (
        <SubMenuItem>
          <SubMenuLink to="/new/m/tree-runner">트리 러너 NZ</SubMenuLink>
        </SubMenuItem>
      )}
    </SubMenuList>
  </DropdownSection>
...
const MenuGroup = ({ title, links, delay }) => (
  <DropdownSection $delay={delay}>
    <DropdownTitle $isUnderlineTitle={title === "유아/어린이"}>
      {title}
    </DropdownTitle>
    <SubMenuList>
      {links.map((link, index) => (
        <SubMenuItem key={index}>
          <SubMenuLink to={link.to}>{link.label}</SubMenuLink>
        </SubMenuItem>
      ))}
    </SubMenuList>
  </DropdownSection>
...
const MenDropdown = () => (
  <DropdownContentWrapper>
    ...
    <MenuGroup
      ...
      delay="0.10s"
    />
    <MenuGroup title="유아/어린이" links={[]} delay="0.15s" />
  </DropdownContentWrapper>
);

const WomenDropdown = () => (
  <DropdownContentWrapper>
    <NewProducts prefix="w" delay="0s" />
    <MenuGroup
      title="여성 신발"
      links={[
  ...
  return (
    <HeaderContainer>
      <ContentWrap>
        ...
        <MainNav>
          <NavItemLink to="/holiday" $isActive={false}>
            홀리데이
            <RedDot />
          </NavItemLink>
          ...
          >
            <NavItemLink to="/men" $isActive={activeDropdown === "men"}>
              남성
            </NavItemLink>
          </NavItemContainer>
          ...
          <NavItemContainer
            ...
            onMouseLeave={handleMouseLeave}
          >
            <NavItemLink to="/women" $isActive={activeDropdown === "women"}>
              여성
            </NavItemLink>
          </NavItemContainer>

          <NavItemLink to="/stores" $isActive={false}>
            매장 위치
          </NavItemLink>
        </MainNav>
